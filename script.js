...
make_site({
    ...
    "authors": [
        ...
        {
            "name": "Min Wei",
            "email": "https://scholar.google.com/citations?user=XMSWYxMAAAAJ",
            "affiliations": ["1","2"],
            "footnote": [""]
        },
        {
            "name": "Shikai Li",
            "email": "https://scholar.google.com/citations?user=WXGg2rgAAAAJ",
            "affiliations": ["1","2"],
            "footnote": [""]
        },
	    {
            "name": "Yizeng Han",
            "email": "https://yizenghan.top",
            "affiliations": ["1","2"],
            "footnote": [""]
        },
        {
            "name": "Hangjie Yuan",
            "email": "https://jacobyuan7.github.io/",
            "affiliations": ["1","2","4"],
            "footnote": [""]
        },
	    {
            "name": "Lei Sun",
            "email": "https://ahupujr.github.io/",
            "affiliations": ["3"],
            "footnote": [""]
        },
        {
            "name": "Weihua Chen",
            "email": "https://scholar.google.com/citations?user=KWVlYaMAAAAJ",
            "affiliations": ["1","2"],
            "footnote": [""]
        },
        {
            "name": "Fan Wang",
            "email": "https://scholar.google.com/citations?user=WCRGTHsAAAAJ",
            "affiliations": ["1","2"],
            "footnote": [""]
        },
    ],
